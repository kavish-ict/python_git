...
class orphans_request(models.Model):
    ...
    organization_id = fields.Many2one('orphans.organization', string="Organization Name")

    state = fields.Selection(selection=[('draft','Draft'),('send', 'Send'), ('confirm', 'Confirm'),('cancel','Cancel')])
